package com.zaeem.myapplication.repository

import androidx.paging.PagedList
import com.twilio.conversations.*
import com.twilio.conversations.Participant.Type.CHAT
import com.zaeem.myapplication.common.*
...
import com.zaeem.myapplication.data.models.RepositoryResult
...
class ConversationsRepositoryImpl(
    ...
    override fun getMessages(conversationSid: String, pageSize: Int): Flow<RepositoryResult<PagedList<MessageListViewItem>>> {
        ...
        val pagedListFlow = localCache.messagesDao().getMessagesSorted(conversationSid)
            ...
            .onStart {
                requestStatusConversation.send(RepositoryRequestStatus.FETCHING)
            }
            .onEach {
                requestStatusConversation.send(RepositoryRequestStatus.COMPLETE)
            }
