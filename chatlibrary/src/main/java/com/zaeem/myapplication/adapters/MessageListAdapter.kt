...
import com.zaeem.myapplication.common.enums.Direction
import com.zaeem.myapplication.common.enums.DownloadState
import com.zaeem.myapplication.common.enums.SendStatus
import com.zaeem.myapplication.data.models.MessageListViewItem
import com.zaeem.myapplication.databinding.RowMessageItemIncomingBinding
import com.zaeem.myapplication.databinding.RowMessageItemOutgoingBinding
import com.zaeem.myapplication.databinding.ViewReactionItemBinding
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val attachmentInfoColor = when {
            message.sendStatus == SendStatus.ERROR ||
                    message.mediaDownloadState == DownloadState.ERROR -> ContextCompat.getColor(context, R.color.colorAccent)

            message.mediaUploading -> ContextCompat.getColor(context, R.color.text_subtitle)

            message.mediaUploadUri != null ||
                    message.mediaDownloadState == DownloadState.COMPLETED -> ContextCompat.getColor(context, R.color.colorPrimary)

            else -> ContextCompat.getColor(context, R.color.text_subtitle)
        }

        val attachmentOnClickListener = View.OnClickListener {
            if (message.mediaDownloadState == DownloadState.COMPLETED && message.mediaUri != null) {
